...
public class ContactsProvider2 extends AbstractContactsProvider
    ...
    // tag for filtering the log message
    static final String My_TAG = "C_Tag";               
    ...
    static {
        ...
        Log.v(My_TAG, "INSERT_URI_ID_VALUE_MAP Called");
    }
    ...
    private interface DataContactsQuery {
        ...
        //Log.v(My_TAG, "DataContactsQuery Called");
    }
    ...
    interface RawContactsQuery {
        ...
        //Log.v(My_TAG, "RawContactsQuery Called");
    }
    ...
    private static final String[] DISTINCT_DATA_PROHIBITING_COLUMNS = {
            ...
            //Log.v(My_TAG, "DISTINCT_DATA_PROHIBITING_COLUMNS Called");
    };
    ...
    private boolean initialize() {
        ...
        Log.v(My_TAG, "initialize() Called");
    ...
    private static LocaleSet updateLocaleSet(LocaleSet oldLocales, Locale newLocale) {
        ...
        Log.v(My_TAG, "updateLocaleSet Called");
    ...
    private void initForDefaultLocale() {
        ...
        Log.v(My_TAG, "initForDefaultLocale() Called");
    }
    ...
    private void initDataRowHandlers(Map<String, DataRowHandler> handlerMap,
        ...
        Log.v(My_TAG, "initDataRowHandlers Called");
    }
    ...
    protected void performBackgroundTask(int task, Object arg) {
        ...
        Log.v(My_TAG, "performBackgroundTask Called");

        switchToContactMode();
        Log.v(My_TAG, "performBackgroundTask task " + task + " is called");
    ...
    private static boolean needsToUpdateLocaleData(SharedPreferences prefs,
        ...
        Log.v(My_TAG, "needsToUpdateLocaleData Called");
    ...
    protected void updateLocaleInBackground() {
        ...
        Log.v(My_TAG, "updateLocaleInBackground Called");
    ...
    private void changeLocaleInBackground() {
        ...
        Log.v(My_TAG, "changeLocaleInBackground Called");
    ...
    private void updateProviderStatus() {
        ...
        Log.v(My_TAG, "updateProviderStatus Called"); 
    ...
    private boolean mapsToProfileDbWithInsertedValues(Uri uri, ContentValues values) {
        ...
        Log.v(My_TAG, "Determines whether the given URI with the given values being inserted should be directed to the profile database rather than the contacts database");
    ...
    private void switchToProfileMode() {
        ...
        Log.v(My_TAG, "switchToProfileMode");
    ...
    private void switchToContactMode() {
        ...
        Log.v(My_TAG, "switchToContactMode");
    ...
    public ContentProviderResult[] applyBatch(ArrayList<ContentProviderOperation> operations)
        ...
        Log.v(My_TAG, "applyBatch called");
    ...
    protected void onBeginTransactionInternal(boolean forProfile) {
        ...
        Log.v(My_TAG, "onBeginTransactionInternal called");
    ...
    protected void onCommitTransactionInternal(boolean forProfile) {
        ...
        Log.v(My_TAG, "onCommitTransactionInternal called");
    ...
    protected Uri insertInTransaction(Uri uri, ContentValues values) {
        ...
        Log.v(My_TAG, "insertInTransaction called");
    ...
    private long cleanUpOldStreamItems(long rawContactId, long insertedStreamItemId) {
        ...
        Log.v(My_TAG, "cleanUpOldStreamItems called");
    ...
    private long insertGroup(Uri uri, ContentValues inputValues, boolean callerIsSyncAdapter) {
        ...
        Log.v(My_TAG, "insertGroup called");
    ...
    private long insertStatusUpdate(ContentValues inputValues) {
        ...
        Log.v(My_TAG, "insertStatusUpdate called");
    ...
    public int deleteGroup(Uri uri, long groupId, boolean callerIsSyncAdapter) {
        ...
        Log.v(My_TAG, "deleteGroup called");
    ...
    private int updateGroups(ContentValues originalValues, String selectionWithId,
        ...
        Log.v(My_TAG, "updateGroup called");
    ...
    protected Cursor queryLocal(final Uri uri, final String[] projection, String selection,
        ...
        Log.v(My_TAG, "querylocal called");
        ...
        final int match = sUriMatcher.match(uri);
        Log.v(My_TAG, "Now calling match: " + match);
        //final int match = 10000;
	    //Log.v(My_TAG, "calling match: " + match + " instead");
        switch (match) {
            case SYNCSTATE:
            case PROFILE_SYNCSTATE:
            ...
            case CONTACTS: {
                ...
                //selectionArgs = insertSelectionArg(selectionArgs, "3");
    ...
    */
    ...
    private Cursor query(final SQLiteDatabase db, SQLiteQueryBuilder qb, String[] projection,
        ...
        Log.v(My_TAG, "query (L6583) called");
        ...
        // add something to change the query arguments before querying the database
        Log.v(My_TAG, "query(L6583):"+"  projection=" + Arrays.toString(projection) +
                    "  selection=[" + selection + "]  args=" + Arrays.toString(selectionArgs) +
                    "  order=[" + sortOrder + "]");
        ...
        Log.v(My_TAG, "query cursor MIMETYPE " + c.getColumnIndex(ContactsContract.Data.MIMETYPE));
        return c;
    }

    // obtain the package name call this contacts provider
    //private static Collections<String> getCallingPackages(Context context) {
    //int callingUid = Binder.getCallingUid();
    //if (callingUid == 0) {
    //    Log.v(My_TAG, "callingUid = 0");
    //    return Collections.emptyList();
    ...
    private Cursor queryPhoneLookupEnterprise(String phoneNumber, String[] projection,
        ...
        Log.v(My_TAG, "queryPhoneLookupEnterprise called");
    ...
    private Cursor queryWithContactIdAndLookupKey(SQLiteQueryBuilder lookupQb,
        ...
        Log.v(My_TAG, "queryWithContactIdAndLookupKey called");
    ...
    public long lookupContactIdByLookupKey(SQLiteDatabase db, String lookupKey) {
        ...
        Log.v(My_TAG, "lookupContactIdByLookupKey called");
    ...
    private long lookupSingleContactId(SQLiteDatabase db) {
        ...
        Log.v(My_TAG, "lookupSingleContactId called");
    ...
    private long lookupContactIdBySourceIds(
        ...
        Log.v(My_TAG, "lookupContactIdBySourceIds called");
    ...
    private long lookupContactIdByRawContactIds(SQLiteDatabase db,
        ...
        Log.v(My_TAG, "lookupContactIdByRawContactIds called");
    ...
    private long lookupContactIdByDisplayNames(
        ...
        Log.v(My_TAG, "lookupContactIdByDisplayNames called");
    ...
    private long getMostReferencedContactId(ArrayList<LookupKeySegment> segments) {
        ...
        Log.v(My_TAG, "getMostReferencedContactId called");
    ...
    public void appendSearchIndexJoin(StringBuilder sb, String filter,
        ...
        Log.v(My_TAG, "appendSearchIndexJoin called");
    ...
    private void outputRawContactsAsVCard(
        ...
        Log.v(My_TAG, "outputRawContactsAsVCard called");
